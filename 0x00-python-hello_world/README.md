...
<ul>
<li><a href="https://intranet.alxswe.com/rltoken/JsFCs_NBzMAR7-XPAZ9BoA" title="The Python tutorial" target="_blank">The Python tutorial</a> (<em>only the first three chapters below</em>)</li>
<li><a href="https://intranet.alxswe.com/rltoken/kifRlLG2iMX5AZiW8lrCMg" title="Whetting Your Appetite" target="_blank">Whetting Your Appetite</a> </li>
...
&gt;&gt;&gt; print(a[0:6])
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="1007" data-correction-id="19075945">
        <div class="task_progress_bar" style="width: 100.0%">
          <div class="task_score_bar" style="width: 50.0%">
          </div>
        </div>
        <div class="task_progress_score_text">
          Score: <span class="task_score_value">50.0%</span> (<span class="task_progress_value">Checks completed: 100.0%</span>)
        </div>
      </div>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="1007" data-batch-id="96" data-toggle="modal" data-target="#task-1007-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-1007-users-done-modal" data-task-id="1007" data-batch-id="96">
            ...
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="1007" data-last-request-id="106634439">Start a new test</button>
    ...
    <button class="btn btn-default btn-sm" data-toggle="modal" data-target="#container-specs-modal" data-gtm-custom-event-name="task_sandbox_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:1007}"><i aria-hidden="true" class="fa fa-terminal "></i><span>Get a sandbox</span></button>
      ...
      <div class="modal fade task_get_qa_review" id="task-qa-review-1007-modal" data-correction-id="19075945" data-task-id="1007">
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="1012" data-correction-id="19075945">
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="1012" data-batch-id="96" data-toggle="modal" data-target="#task-1012-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-1012-users-done-modal" data-task-id="1012" data-batch-id="96">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="1012" data-last-request-id="106634688">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
    ...
    <div class="help-container" data-task-id="1012">
      ...
      <button class="btn btn-primary btn-sm task_ask_new_correction " data-task-id="1012" data-correction-id="19075945">
    ...
    <button class="btn btn-default btn-sm" data-toggle="modal" data-target="#container-specs-modal" data-gtm-custom-event-name="task_sandbox_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:1012}"><i aria-hidden="true" class="fa fa-terminal "></i><span>Get a sandbox</span></button>
      ...
      <div class="modal fade task_get_qa_review" id="task-qa-review-1012-modal" data-correction-id="19075945" data-task-id="1012">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="1013" data-correction-id="19075945">
        <div class="task_progress_bar" style="width: 100.0%">
          <div class="task_score_bar" style="width: 50.0%">
          </div>
        </div>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="1013" data-batch-id="96" data-toggle="modal" data-target="#task-1013-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-1013-users-done-modal" data-task-id="1013" data-batch-id="96">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="1013" data-last-request-id="106635244">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
    ...
    <button class="btn btn-default btn-sm" data-toggle="modal" data-target="#container-specs-modal" data-gtm-custom-event-name="task_sandbox_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:1013}"><i aria-hidden="true" class="fa fa-terminal "></i><span>Get a sandbox</span></button>
      ...
      <div class="modal fade task_get_qa_review" id="task-qa-review-1013-modal" data-correction-id="19075945" data-task-id="1013">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="1019" data-correction-id="19075945">
        <div class="task_progress_bar" style="width: 77.78%">
          <div class="task_score_bar" style="width: 50.0%">
          </div>
        </div>
        <div class="task_progress_score_text">
          Score: <span class="task_score_value">38.89%</span> (<span class="task_progress_value">Checks completed: 77.78%</span>)
        </div>
      </div>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="1019" data-batch-id="96" data-toggle="modal" data-target="#task-1019-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-1019-users-done-modal" data-task-id="1019" data-batch-id="96">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="1019" data-last-request-id="106635440">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
    ...
    <div class="help-container" data-task-id="1019">
      ...
      <button class="btn btn-primary btn-sm task_ask_new_correction " data-task-id="1019" data-correction-id="19075945">
        Ask for a new correction
        <span class="in_progress_info">: in progress...</span>
        <span class="error_occurred_info">: an error occurred</span>
      </button>
    ...
    <button class="btn btn-default btn-sm" data-toggle="modal" data-target="#container-specs-modal" data-gtm-custom-event-name="task_sandbox_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:1019}"><i aria-hidden="true" class="fa fa-terminal "></i><span>Get a sandbox</span></button>
      ...
      <div class="modal fade task_get_qa_review" id="task-qa-review-1019-modal" data-correction-id="19075945" data-task-id="1019">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="1020" data-correction-id="19075945">
        <div class="task_progress_bar" style="width: 100.0%">
          <div class="task_score_bar" style="width: 50.0%">
          </div>
        </div>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="1020" data-batch-id="96" data-toggle="modal" data-target="#task-1020-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-1020-users-done-modal" data-task-id="1020" data-batch-id="96">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="1020" data-last-request-id="106635627">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
    ...
    <button class="btn btn-default btn-sm" data-toggle="modal" data-target="#container-specs-modal" data-gtm-custom-event-name="task_sandbox_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:1020}"><i aria-hidden="true" class="fa fa-terminal "></i><span>Get a sandbox</span></button>
      ...
      <div class="modal fade task_get_qa_review" id="task-qa-review-1020-modal" data-correction-id="19075945" data-task-id="1020">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="1021" data-correction-id="19075945">
        <div class="task_progress_bar" style="width: 100.0%">
          <div class="task_score_bar" style="width: 50.0%">
          </div>
        </div>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="1021" data-batch-id="96" data-toggle="modal" data-target="#task-1021-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-1021-users-done-modal" data-task-id="1021" data-batch-id="96">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="1021" data-last-request-id="106635737">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
    ...
    <button class="btn btn-default btn-sm" data-toggle="modal" data-target="#container-specs-modal" data-gtm-custom-event-name="task_sandbox_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:1021}"><i aria-hidden="true" class="fa fa-terminal "></i><span>Get a sandbox</span></button>
      ...
      <div class="modal fade task_get_qa_review" id="task-qa-review-1021-modal" data-correction-id="19075945" data-task-id="1021">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="1079" data-correction-id="19075945">
        <div class="task_progress_bar" style="width: 100.0%">
          <div class="task_score_bar" style="width: 50.0%">
          </div>
        </div>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="1079" data-batch-id="96" data-toggle="modal" data-target="#task-1079-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-1079-users-done-modal" data-task-id="1079" data-batch-id="96">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="1079" data-last-request-id="106638375">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
    ...
    <button class="btn btn-default btn-sm" data-toggle="modal" data-target="#container-specs-modal" data-gtm-custom-event-name="task_sandbox_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:1079}"><i aria-hidden="true" class="fa fa-terminal "></i><span>Get a sandbox</span></button>
      ...
      <div class="modal fade task_get_qa_review" id="task-qa-review-1079-modal" data-correction-id="19075945" data-task-id="1079">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="1080" data-correction-id="19075945">
        <div class="task_progress_bar" style="width: 100.0%">
          <div class="task_score_bar" style="width: 50.0%">
          </div>
        </div>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="1080" data-batch-id="96" data-toggle="modal" data-target="#task-1080-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-1080-users-done-modal" data-task-id="1080" data-batch-id="96">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="1080" data-last-request-id="106638926">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
    ...
    <button class="btn btn-default btn-sm" data-toggle="modal" data-target="#container-specs-modal" data-gtm-custom-event-name="task_sandbox_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:1080}"><i aria-hidden="true" class="fa fa-terminal "></i><span>Get a sandbox</span></button>
      ...
      <div class="modal fade task_get_qa_review" id="task-qa-review-1080-modal" data-correction-id="19075945" data-task-id="1080">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="1081" data-correction-id="19075945">
        <div class="task_progress_bar" style="width: 0.0%">
          <div class="task_score_bar" style="width: NaN%">
          </div>
        </div>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="1081" data-batch-id="96" data-toggle="modal" data-target="#task-1081-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-1081-users-done-modal" data-task-id="1081" data-batch-id="96">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="1081" data-last-request-id="106642570">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
    ...
    <div class="help-container" data-task-id="1081">
      ...
      <button class="btn btn-primary btn-sm task_ask_new_correction " data-task-id="1081" data-correction-id="19075945">
        Ask for a new correction
        <span class="in_progress_info">: in progress...</span>
        <span class="error_occurred_info">: an error occurred</span>
      </button>
    ...
    <button class="btn btn-default btn-sm" data-toggle="modal" data-target="#container-specs-modal" data-gtm-custom-event-name="task_sandbox_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:1081}"><i aria-hidden="true" class="fa fa-terminal "></i><span>Get a sandbox</span></button>
      ...
      <div class="modal fade task_get_qa_review" id="task-qa-review-1081-modal" data-correction-id="19075945" data-task-id="1081">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="1082" data-correction-id="19075945">
        <div class="task_progress_bar" style="width: 100.0%">
          <div class="task_score_bar" style="width: 50.0%">
          </div>
        </div>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="1082" data-batch-id="96" data-toggle="modal" data-target="#task-1082-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-1082-users-done-modal" data-task-id="1082" data-batch-id="96">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="1082" data-last-request-id="106643741">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
    ...
    <button class="btn btn-default btn-sm" data-toggle="modal" data-target="#container-specs-modal" data-gtm-custom-event-name="task_sandbox_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:1082}"><i aria-hidden="true" class="fa fa-terminal "></i><span>Get a sandbox</span></button>
      ...
      <div class="modal fade task_get_qa_review" id="task-qa-review-1082-modal" data-correction-id="19075945" data-task-id="1082">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="2656" data-correction-id="19075945">
        <div class="task_progress_bar" style="width: 0.0%">
          <div class="task_score_bar" style="width: NaN%">
          </div>
        </div>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="2656" data-batch-id="96" data-toggle="modal" data-target="#task-2656-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-2656-users-done-modal" data-task-id="2656" data-batch-id="96">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    ...
    <div class="help-container" data-task-id="2656">
      ...
      <button class="btn btn-primary btn-sm task_ask_new_correction " data-task-id="2656" data-correction-id="19075945">
        Ask for a new correction
        <span class="in_progress_info">: in progress...</span>
        <span class="error_occurred_info">: an error occurred</span>
      </button>
    ...
    <button class="btn btn-default btn-sm" data-toggle="modal" data-target="#container-specs-modal" data-gtm-custom-event-name="task_sandbox_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:2656}"><i aria-hidden="true" class="fa fa-terminal "></i><span>Get a sandbox</span></button>
      ...
      <div class="modal fade task_get_qa_review" id="task-qa-review-2656-modal" data-correction-id="19075945" data-task-id="2656">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="1014" data-correction-id="19075945">
        <div class="task_progress_bar" style="width: 0.0%">
          <div class="task_score_bar" style="width: NaN%">
          </div>
        </div>
...
<div>
    <button class="student_task_done btn btn-default btn-sm no" data-task-id="1014">
      <span class="no"><i aria-hidden="true" class="fa fa-square-o "></i></span>
      <span class="yes"><i aria-hidden="true" class="fa fa-check-square-o "></i></span>
      <span class="pending"><i aria-hidden="true" class="fa fa-spinner  fa-pulse"></i></span>
      Done<span class="no pending">?</span><span class="yes">!</span>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="1014" data-batch-id="96" data-toggle="modal" data-target="#task-1014-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-1014-users-done-modal" data-task-id="1014" data-batch-id="96">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    ...
    <div class="help-container" data-task-id="1014">
      ...
      <button class="btn btn-primary btn-sm task_ask_new_correction " data-task-id="1014" data-correction-id="19075945">
        Ask for a new correction
        <span class="in_progress_info">: in progress...</span>
        <span class="error_occurred_info">: an error occurred</span>
      </button>
    ...
    <button class="btn btn-default btn-sm" data-toggle="modal" data-target="#container-specs-modal" data-gtm-custom-event-name="task_sandbox_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:1014}"><i aria-hidden="true" class="fa fa-terminal "></i><span>Get a sandbox</span></button>
      ...
      <div class="modal fade task_get_qa_review" id="task-qa-review-1014-modal" data-correction-id="19075945" data-task-id="1014">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="1010" data-correction-id="19075945">
        <div class="task_progress_bar" style="width: 0.0%">
          <div class="task_score_bar" style="width: NaN%">
          </div>
        </div>
...
<div>
    <button class="student_task_done btn btn-default btn-sm no" data-task-id="1010">
      <span class="no"><i aria-hidden="true" class="fa fa-square-o "></i></span>
      <span class="yes"><i aria-hidden="true" class="fa fa-check-square-o "></i></span>
      <span class="pending"><i aria-hidden="true" class="fa fa-spinner  fa-pulse"></i></span>
      Done<span class="no pending">?</span><span class="yes">!</span>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="1010" data-batch-id="96" data-toggle="modal" data-target="#task-1010-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-1010-users-done-modal" data-task-id="1010" data-batch-id="96">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    ...
    <div class="help-container" data-task-id="1010">
      ...
      <button class="btn btn-primary btn-sm task_ask_new_correction " data-task-id="1010" data-correction-id="19075945">
        Ask for a new correction
        <span class="in_progress_info">: in progress...</span>
        <span class="error_occurred_info">: an error occurred</span>
      </button>
    ...
    <button class="btn btn-default btn-sm" data-toggle="modal" data-target="#container-specs-modal" data-gtm-custom-event-name="task_sandbox_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:1010}"><i aria-hidden="true" class="fa fa-terminal "></i><span>Get a sandbox</span></button>
      ...
      <div class="modal fade task_get_qa_review" id="task-qa-review-1010-modal" data-correction-id="19075945" data-task-id="1010">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="1025" data-correction-id="19075945">
        <div class="task_progress_bar" style="width: 0.0%">
          <div class="task_score_bar" style="width: NaN%">
          </div>
        </div>
...
<div>
    <button class="student_task_done btn btn-default btn-sm no" data-task-id="1025">
      <span class="no"><i aria-hidden="true" class="fa fa-square-o "></i></span>
      <span class="yes"><i aria-hidden="true" class="fa fa-check-square-o "></i></span>
      <span class="pending"><i aria-hidden="true" class="fa fa-spinner  fa-pulse"></i></span>
      Done<span class="no pending">?</span><span class="yes">!</span>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="1025" data-batch-id="96" data-toggle="modal" data-target="#task-1025-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-1025-users-done-modal" data-task-id="1025" data-batch-id="96">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    ...
    <div class="help-container" data-task-id="1025">
      ...
      <button class="btn btn-primary btn-sm task_ask_new_correction " data-task-id="1025" data-correction-id="19075945">
        Ask for a new correction
        <span class="in_progress_info">: in progress...</span>
        <span class="error_occurred_info">: an error occurred</span>
      </button>
    ...
    <button class="btn btn-default btn-sm" data-toggle="modal" data-target="#container-specs-modal" data-gtm-custom-event-name="task_sandbox_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:1025}"><i aria-hidden="true" class="fa fa-terminal "></i><span>Get a sandbox</span></button>
      ...
      <div class="modal fade task_get_qa_review" id="task-qa-review-1025-modal" data-correction-id="19075945" data-task-id="1025">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
